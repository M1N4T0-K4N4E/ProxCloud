  ...
  >
    <div class="grid">
      ...
      <div class="form-group">
        ...
        <input type="number" id="diskSize" name="diskSize" bind:value={formData.diskSize} required />
      </div>
...
<style>
  ...
  label { font-weight: 600; font-size: 0.9rem; margin-bottom: 0.4rem; color: #555; }
  ...
  small { font-size: 0.8rem; color: #888; margin-top: 0.2rem; }
  ...
  button:hover { background-color: #c04b35; }
